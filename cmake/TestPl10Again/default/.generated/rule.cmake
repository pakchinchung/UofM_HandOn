...
function(TestPl10Again_default_default_XC32_assemble_rule target)
    set(options
        "-g"
        "${ASSEMBLER_PRE}"
...
function(TestPl10Again_default_default_XC32_assembleWithPreprocess_rule target)
    set(options
        "-x"
        "assembler-with-cpp"
        "-g"
...
function(TestPl10Again_default_default_XC32_compile_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-x"
...
function(TestPl10Again_default_default_XC32_compile_cpp_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-mprocessor=32CM6408PL10048"
...
function(TestPl10Again_default_dependentObject_rule target)
    set(options
        "-mprocessor=32CM6408PL10048"
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32CM-PL_DFP/1.4.418/pic32cm6408pl")
    list(REMOVE_ITEM options "")
...
function(TestPl10Again_default_link_rule target)
    set(options
        "-g"
        "${MP_EXTRA_LD_PRE}"
        "-mprocessor=32CM6408PL10048"
        "-mno-device-startup-code"
        "-Wl,--defsym=__MPLAB_BUILD=1${MP_EXTRA_LD_POST},--script=${TestPl10Again_default_LINKER_SCRIPT},--defsym=_min_heap_size=512,--gc-sections,-Map=mem.map,--report-mem,--memorysummary,memoryfile.xml"
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32CM-PL_DFP/1.4.418/pic32cm6408pl")
    list(REMOVE_ITEM options "")
